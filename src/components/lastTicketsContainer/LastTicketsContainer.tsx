...
import SeatsContainer from "../TrainRoutes/SeatsContainer/SeatsContainer";
import './LastTicketsContainer.css';

const LastTicketsContainer = (item: ItemRoutes) => {
  return (
    <>
      <div className="last-ticket__item">
      ...
      <div className="last-ticket__item__bottom">
        ...
        <div className="last-ticket__item__bottom__price-container">
          <span>от</span>
          <span>{item.departure.min_price}</span>
