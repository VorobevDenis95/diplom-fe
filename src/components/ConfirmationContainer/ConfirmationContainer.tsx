...
const ConfirmationContainer = ({ list, totalAmount }: ConfirmationContainerProps) => {
    ...
    <div className="confirmation__container">
      ...
      <div className="confirmation__container-box">
        <div className="confirmation__container-price">
          ...
          <div className="confirmation__container-row">
            <span className="confirmation__container-price-total">Всего</span>
            <div className="confirmation__container-price-row">
