...
const GradeStar = ({index, activeIndex, clickStar} :OrderStarProps) => {

  const [isActive, setActive ] = useState(index <= activeIndex);  
  ...
  return (
    <div onClick={() => clickStar(index)}>
      <svg className={`order__star${index}`} 
      width="46" height="44" viewBox="0 0 46 44" fill={isActive ? "white" : "none"} xmlns="http://www.w3.org/2000/svg">
