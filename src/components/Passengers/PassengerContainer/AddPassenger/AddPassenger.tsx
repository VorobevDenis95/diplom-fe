import { AddPassengersProps } from "../../../../shared/types/components/componentsTypes";
import './AddPassenger.css';

const AddPasseger = ({ clickAction }: AddPassengersProps) => {
  return (
    <div className="passenger__item">
      <div className="passenger__item__header">
        <h3 className="passenger__item__header__title">Добавить пассажира</h3>
        <button className="passenger__item-action-btn" onClick={clickAction}>
