  ...
  return (
    <>
      <div className='railway-carriage__container'>
        <TypeRailwayCarriage clickTypeElement={clickTypeEl} 
      ...
      {data.length >0 && <AboutRailwayCarriage data={data} typeDirection={typeDirection}/>}
    </>

  )
}

export default ContainerRailwayCarriage;